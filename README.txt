...
From a terminal window:	pip install python-xlib
						sudo apt-get install python-dev (need to test to see if we really need this)
						pip install pyautogui

4. If you are using the official RPi 7" touchscreen and want to be able to control the on/off and brightness of the display, you need to add the rpi backlight module.  As per the github repo for this module, you may also need to edit the backlight rules (need to test to see if this is true).
